const secret_id='腾讯云SecretID';
const secret_key='腾讯云SecretKey';
const smsSdkAppid='腾讯云短信APPID';
const sign='签名';
const templateID='短信模板号';
const tencentcloud = require("tencentcloud-sdk-nodejs");
module.exports={
    send(mobile,params,callbackFn){
